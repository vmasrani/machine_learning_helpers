...
def nested_dict():
    """
    Returns a nested defaultdict object.

    This function creates and returns a nested defaultdict object, which allows you to create dictionaries with an arbitrary number of nested levels.
...
def read_sql_query_tqdm(query, con, chunksize=1000, **kwargs):
    ...
    total_rows = pd.read_sql_query(count_rows, con=con).iloc[0,0]
